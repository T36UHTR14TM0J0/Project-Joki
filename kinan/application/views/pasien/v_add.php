<div class="container-fluid">     
    <div class="card shadow bg-info pt-3">
        <div class="container">
            <h3 class="text-title text-light text-center"> FORM TAMBAH PASIEN</h3>
        </div>
    </div>

    <div class="card shadow mb-4 mt-2">
        <div class="card-body">
            <form method ="POST" action="<?php echo base_url() . "index.php/pasien/processAdd/" ?>">
                ...
                <div class="row m-auto">
                     <div class="form-group  col-md-4 col-md-4">
                        ...
                        <select class="form-control" id="id_registrasi" name="id_registrasi" id="id_registrasi">
                         <option>--pilih--</option>
                            <?php 
                                foreach ($data_reg as $dr): 
                                    $id_registrasi = $dr['id_registrasi'];
                                    $cek_data = $this->ModelPosyandu->cekId('pasien',"WHERE id_registrasi = '$id_registrasi'");
                    ...
                    <div class="form-group col-md-4">
                        <label>Alamat</label>
                       <input autocomplete="off" class="form-control" type="text" name="alamat" id="alamat">
                    </div>
