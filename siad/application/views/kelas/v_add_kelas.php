...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-body border border-primary rounded-lg shadow-sm">
          <div class="row">
            <div class="col-sm-6">
              <h1 class="text-primary">&nbsp;FORM TAMBAH KELAS</h1>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="content-body">
    <div class="container">
      <div class="card">
        <form method="POST" action="<?php echo base_url('C_kelas/proses_add'); ?>" enctype="multipart/form-data">
          <div class="card-body">
            <div class="row">

                <div class="form-group col-md-4">
                  <label class="text-primary">ID KELAS</label>
                  <input type="text" name="id_kelas" class="form-control" id="id_kelas" value="<?php echo $id_kelas; ?>" readonly>
                </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="number" name="jml_siswa" class="form-control" id="jml_siswa">
                </div>
