...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body border border-primary rounded-lg shadow-sm">
            <div class="row">
              <div class="col-sm-6">
                <h1 class="text-primary">&nbsp;TAMBAH JENIS PEMBAYARAN</h1>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="content-body">
    <div class="container">
      <div class="card">
        <form method="POST" action="<?php echo base_url('C_jenis_pembayaran/proses_add'); ?>" enctype="multipart/form-data">
          <div class="card-body">
            <div class="row">
                <div class="form-group col-md-4">
                  <label class="text-primary">KODE JENIS PEMBAYARAN</label>
                  <input type="text" name="kode_jenis_pembayaran" class="form-control" id="kode_jenis_pembayaran" value="<?php echo $kode_jenis_pembayaran; ?>" readonly>
                </div>
                <div class="form-group col-md-4">
                  <label class="text-primary">NAMA PEMBAYARAN</label>
                  <input type="text" name="nama_pembayaran" class="form-control" id="nama_pembayaran">
                </div>
                <div class="form-group col-md-4">
