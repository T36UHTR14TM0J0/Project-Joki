...
<div class="content-wrapper">
  ...
  <div class="content-body">
    <div class="container">
      <div class="card">
        <form method="POST" action="<?php echo base_url('C_user/proses_edit'); ?>" enctype="multipart/form-data">
          <div class="card-body">
            <div class="row">
              <?php foreach ($Data_user as $Du): ?>
                <div class="form-group col-md-4">
                  <label class="text-primary">ID USER</label>
                  <input type="text" name="id_user" class="form-control" id="id_user" value="<?php echo $Du['id_user']; ?>" readonly>
                </div>

                <div class="form-group col-md-4">
                  <label class="text-primary">USERNAME</label>
                  <input type="text" name="username" class="form-control" id="username" value="<?php echo $Du['username']; ?>">
                </div>
