...
<head>
    ...
    <title>Toko Kurnia  <?php if(isset($_GET["pages"])){ echo " - " . $_GET["pages"] ;}?></title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?pages=home">
                ...
                <div class="sidebar-brand-text mx-3" style="font-size: 12px;">TOKO Kurnia</div>
            </a>
           ...
           <?php if ($akses === "admin"): ?>
                <!-- Nav Item - Data User-->
                <li class="nav-item">
                    <a class="nav-link" href="index.php?pages=user">
           ...
           <?php endif ?>
            ...
            <li class="nav-item">
                ...
                <!-- Nav Item - Apk Kasir -->
                <li class="nav-item">
                    <a class="nav-link" href="index.php?pages=apk">
                        <i class="fas fa-fw fa-cash-register"></i>
                        <span>APK Kasir</span></a>
                </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand bg-danger navbar-dark topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Tanggal -->
                    <div class="d-none d-sm-inline-block text-light  mr-auto ml-md-3 my-2 my-md-0 mw-100">
                        ...
                        if (isset($_GET['pages'])) {
                            ...
                            switch ($page) {
                                ...
                                case "product":
                                    ...
                                    if ($akses !== 'admin') {
                                        echo "<script>
                                                window.location.href = 'index.php?notif_gagal=Anda Login Sebagai Admin!';
                                        </script>";
                                ...
                                if ($akses !== 'admin') {
                                        echo "<script>
                                                window.location.href = 'index.php?notif_gagal=Anda Login Sebagai Kasir / Penjual';
                                        </script>";
                                        
                                    }
                                    include "users/v_users.php";
                                    break;
            ...
            <!-- Footer -->
            <footer class="sticky-footer bg-danger text-light">
